...
export const Intro = () => {
  const buttonStyle =
    " p-0.5 px-2 font-semibold border-2 border-black text-sm bg-primary text-on-primary hover:bg-secondary hover:text-on-secondary transition ease-in-out duration-300";
